...
// Add this at the top of your route.ts file, after the imports
  ...
  (server) => {
    ...
    server.tool(
      ...
      "Get data from a specific sheet in a Google Spreadsheet. Returns cell values from the specified range or entire sheet.",
      {
        spreadsheet_id: z
          .string()
          .describe("The ID of the spreadsheet (found in the URL)"),
        sheet: z.string().describe("The name of the sheet"),
        range: z
          .string()
          .optional()
          .describe(
            "Optional cell range in A1 notation (e.g., 'A1:C10'). If not provided, gets all data."
          ),
        include_grid_data: z
          .boolean()
          .optional()
      ...
      async (args) => {
        const result = await getSheetData(
          args as z.infer<typeof getSheetDataSchema>
        );
        return {
    ...
    server.tool(
      ...
      "Get formulas from a specific sheet in a Google Spreadsheet. Returns formulas (not values) from the specified range.",
      {
        ...
        range: z
          ...
          .optional()
          .describe(
            "Optional cell range in A1 notation. If not provided, gets all formulas from the sheet."
          ),
      },
      async (args) => {
        const result = await getSheetFormulas(
          args as z.infer<typeof getSheetFormulasSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      "Update cells in a Google Spreadsheet. Overwrites existing data in the specified range with new values.",
      {
        ...
        range: z
          .string()
          .describe("Cell range in A1 notation (e.g., 'A1:C10')"),
        data: z
      ...
      async (args) => {
        const result = await updateCells(
          args as z.infer<typeof updateCellsSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      "Batch update multiple ranges in a Google Spreadsheet. Efficiently updates multiple ranges in a single API call.",
      {
        ...
        sheet: z.string().describe("The name of the sheet"),
        ranges: z
          .record(z.string(), z.array(z.array(z.unknown())))
          .describe("Dictionary mapping range strings to 2D arrays of values"),
      },
      async (args) => {
        const result = await batchUpdateCells(
          args as z.infer<typeof batchUpdateCellsSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      "Add rows to a sheet in a Google Spreadsheet. Inserts empty rows at the specified position.",
      {
        ...
        start_row: z
          ...
          .optional()
          .describe(
            "0-based row index to start adding. If not provided, adds at the beginning."
          ),
      },
      async (args) => {
    ...
    server.tool(
      ...
      "Add columns to a sheet in a Google Spreadsheet. Inserts empty columns at the specified position.",
      {
        ...
        start_column: z
          ...
          .optional()
          .describe(
            "0-based column index to start adding. If not provided, adds at the beginning."
          ),
      },
      async (args) => {
        const result = await addColumns(
          args as z.infer<typeof addColumnsSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      async (args) => {
        const result = await listSheets(
          args as z.infer<typeof listSheetsSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      async (args) => {
        const result = await renameSheet(
          args as z.infer<typeof renameSheetSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      async (args) => {
        const result = await getMultipleSheetData(
          args as z.infer<typeof getMultipleSheetDataSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      "Get a summary of multiple Google Spreadsheets. Returns titles, sheet names, headers, and first few rows for each spreadsheet.",
      {
        spreadsheet_ids: z
          .array(z.string())
          .describe("List of spreadsheet IDs to summarize"),
        rows_to_fetch: z
          .number()
          .optional()
          .default(5)
          .describe("Number of rows to fetch for the summary (default: 5)"),
      },
      async (args) => {
        const result = await getMultipleSpreadsheetSummary(
          args as z.infer<typeof getMultipleSpreadsheetSummarySchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      "Create a new Google Spreadsheet. Creates a new spreadsheet in the specified folder or root.",
      {
        ...
        folder_id: z
          ...
          .optional()
          .describe(
            "Optional Google Drive folder ID where the spreadsheet should be created"
          ),
      },
      async (args) => {
        const result = await createSpreadsheet(
          args as z.infer<typeof createSpreadsheetSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      async (args) => {
        const result = await createSheet(
          args as z.infer<typeof createSheetSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      "List all spreadsheets in the specified Google Drive folder. Returns spreadsheet IDs and titles.",
      {
        folder_id: z
          .string()
          .optional()
          .describe("Optional Google Drive folder ID to search in"),
      },
      async (args) => {
        const result = await listSpreadsheets(
          args as z.infer<typeof listSpreadsheetsSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      "Share a Google Spreadsheet with multiple users via email. Assigns specific roles (reader, commenter, writer) to each recipient.",
      {
        ...
        send_notification: z
          ...
          .optional()
          .default(true)
          .describe("Whether to send notification email"),
      },
      async (args) => {
        const result = await shareSpreadsheet(
          args as z.infer<typeof shareSpreadsheetSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      "List all folders in the specified Google Drive folder. Returns folder IDs, names, and parent information.",
      {
        parent_folder_id: z
          .string()
          .optional()
          .describe("Optional parent folder ID to search within"),
      },
      async (args) => {
        const result = await listFolders(
          args as z.infer<typeof listFoldersSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
    ...
    server.tool(
      ...
      "Execute a batch update on a Google Spreadsheet. Provides access to all batchUpdate operations including adding sheets, updating properties, inserting/deleting dimensions, formatting, and more.",
      {
        ...
        requests: z
          ...
          .describe("List of batchUpdate request objects"),
      },
      async (args) => {
        const result = await batchUpdate(
          args as z.infer<typeof batchUpdateSchema>
        );
        return {
          content: [{ type: "text", text: JSON.stringify(result, null, 2) }],
        };
